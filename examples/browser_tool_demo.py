...
async def demo_simple_search():
    ...
    # TODO: Uncomment when browser_tool is implemented
    ...
    print("TODO: Implement browser_tool")
...
async def demo_llm_synthesis():
    ...
    # TODO: Uncomment when browser_tool is implemented
    # from tools.browser_tool import BrowserTool
    # from utils import get_openai_client, get_agent_config
    #
    # browser = BrowserTool(agent_name="demo")
    # result = await browser.search_and_visit(
    ...
    # client = get_openai_client(config=config)
    #
    # messages = [
